...
"""
'''
googlemap.py 計算出從Google地圖查詢所有地點之間的 距離和 交s通時間
google_search.py 計算出從Google地圖查詢所有地點的 停留時間
routeplan.py 從Google抓各景點的停留時間
stoptime.py 將停留時間轉為可抓取的值
alltime.py 顯示推薦路線的各點交通時間、停留時間，及加總
'''
...
def main(search_tag_list = ['台北車站','富貴角燈塔', '十分瀑布', '木蘭閣']):
    ...
    # google_distance_list = ['{"出發地點": "台北車站", "目的地": "富貴角燈塔", "所需時間": " 1 小時 9 分 (41.0 公里)  ", "路徑": [" 走縱貫公路/台1線和台64線前往新北的五股一交流道(五股)。從台64線的 10-五股一 號出口下交流道  ", " 走103縣道和關渡大橋/台15線前往淡水區的北部濱海公路/民權路/台2乙線/台2線  ", " 沿北部濱海公路/台2線前往石門區的楓林大橋  ", " 行駛到楓林路  "]}',
    # '{"出發地點": "台北車站", "目的地": "十分瀑布", "所需時間": " 39 分 (34.1 公里)  ", "路徑": [" 走市民大道二段和市民大道三段前往大安區的市民大道  ", " 繼續走市民大道前往內湖區。從環東大道出口下交流道前往Neihu  ", " 走國道一號/國道1號  ", " 繼續走國道一號前往暖暖區。從國道一號的 2-八堵 號出口下交流道  ", " 繼續走基福公路/台2丙線。行駛到平溪區的十分觀光大橋  "]}',
    # '{"出發地點": "台北車站", "目的地": "木蘭閣", "所需時間": " 10 分 (4.6 公里)  ", "路徑": ["   "]}',
    # '{"出發地點": "富貴角燈塔", "目的地": "台北車站", "所需時間": " 1 小時 11 分 (39.7 公里)  ", "路徑": [" 繼續開往北部濱海公路/淡金公路/台2線  ", " 沿北部濱海公路/淡金公路/台2線、台2乙線和洲美快速道路/洲美快速道路(洲美快速道路 承德路/北投 淡水)前往台北的民族西路  ", " 繼續走民族西路。走承德路二段前往中正區的市民大道一段  "]}',
    # '{"出發地點": "富貴角燈塔", "目的地": "十分瀑布", "所需時間": " 1 小時 16 分 (51.9 公里)  ", "路徑": [" 走楓林路前往北部濱海公路/淡金公路/台2線  ", " 沿北部濱海公路/台2線、台62線和基福公路/台2丙線前往平溪區  ", " 走十分街前往十分觀光大橋  "]}',
    # '{"出發地點": "富貴角燈塔", "目的地": "木蘭閣", "所需時間": " 1 小時 14 分 (55.5 公里)  ", "路徑": [" 走楓林路前往北部濱海公路/淡金公路/台2線  ", " 沿北部濱海公路/台2線、台62線和國道一號前往台北的南京東路六段。從國道一號的 17A-內湖 號出口下交流道  ", " 繼續走南京東路六段。走麥帥一橋、南京東路五段和南京東路四段前往松山區的敦化北路  "]}',
    # '{"出發地點": "十分瀑布", "目的地": "台北車站", "所需時間": " 44 分 (38.0 公里)  ", "路徑": [" 從基福公路/台2丙線開往七堵區的國道一號/國道1號  ", " 繼續走國道一號前往台北。從建國高架道路的忠孝東路出口下交流道  ", " 繼續走忠孝東路/台5線。行駛到中正區的忠孝西路一段/縱貫公路/台1線/台3線  "]}', '{"出發地點": "十分瀑布", "目的地": "富貴角燈塔", "所需時間": " 1 小時 20 分 (51.9 公里)  ", "路徑": [" 沿十分街前往基福公路/台2丙線  ", " 沿基福公路/台2丙線、台62線和北部濱海公路/台2線前往石門區的楓林大橋  ", " 行駛到楓林路  "]}',
    # '{"出發地點": "十分瀑布", "目的地": "木蘭閣", "所需時間": " 42 分 (30.8 公里)  ", "路徑": [" 沿十分街前往基福公路/台2丙線  ", " 沿基福公路/台2丙線和國道一號前往台北的南京東路六段。從國道一號的 17A-內湖 號出口下交流道  ", " 繼續走南京東路六段。走麥帥一橋、南京東路五段和南京東路四段前往松山區的敦化北路  "]}',
    # '{"出發地點": "木蘭閣", "目的地": "台北車站", "所需時間": " 12 分 (5.1 公里)  ", "路徑": ["   "]}', '{"出發地點": "木蘭閣", "目的地": "富貴角燈塔", "所需時間": " 1 小時 15 分 (42.0 公里)  ", "路徑": [" 從民權東路三段開往中山區的國道一號  ", " 繼續走國道一號前往士林區  ", " 繼續開往延平北路七段  ", " 走北部濱海公路/淡金公路/台2線前往石門區的楓林大橋  ", " 行駛到楓林路  "]}',
    # '{"出發地點": "木蘭閣", "目的地": "十分瀑布", "所需時間": " 42 分 (31.3 公里)  ", "路徑": [" 從敦化北路、民權東路四段、民權大橋、民權東路六段和成功路二段開往內湖區的國道一號/國道1號  ", " 沿國道一號和基福公路/台2丙線前往平溪區  ", " 走十分街前往十分觀光大橋  "]}']
